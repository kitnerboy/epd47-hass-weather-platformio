...
const char* password = "YOU_PSK_HERE";

// Use your own API key by signing up for a free developer account at https://openweathermap.org/

//Set your location according to OWM locations
String City             = "Tbilisi";                          // Your home city See: http://bulk.openweathermap.org/sample/
String Country          = "GE";                            // Your _ISO-3166-1_two-letter_country_code country code, on OWM find your nearest city and the country code is displayed
...
const char* Timezone    = "<+04>-4";  // Choose your time zone from: https://github.com/nayarsystems/posix_tz_db/blob/master/zones.csv 
